...
//  and add the line ' #include "Detector_G3new.hh" ' , and make sure the "auto
//  detector" variable is the "Detector_G3new()" object, as opposed to the LUX
//  default. You may also want to remove the few lines of LUX-detector comments
//  between lines 42-45 of execNEST.cpp
////////////////////////////////////////////////////////////////////////////////////

#ifndef Detector_G3new_hh
#define Detector_G3new_hh 1

#include "VDetector.hh"

using namespace std;

class Detector_G3new : public VDetector {
 public:
  Detector_G3new() {
    // Call the initialisation of all the parameters
    Initialization();
  };
  ~Detector_G3new() override = default;
